...
(function (root, factory) {
    ...
    if (Blockly.isNumber(c) && Blockly.isNumber(d) && Blockly.isNumber(e))
      ...
      var m = function (g, l) {
        Blockly.isNumber(g)
          ...
          : g.match(/^\w+$/)
          ? (g = "float(" + g + ")")
          : ((l = Blockly.Python.nameDB_.getDistinctName(
              b + l,
              Blockly.VARIABLE_CATEGORY_NAME
            )),
            (n += l + " = float(" + g + ")\n"),
  ...
  Blockly.Python.math_change = function (a) {
    ...
    return (
      a + " = (" + a + " if isinstance(" + a + ", int) else 0) + " + b + "\n"
    );
  };
  ...
  Blockly.Python.procedures_defreturn = function (a) {
    for (
      var b = [],
        c = a.workspace,
        d = Blockly.Variables.allUsedVarModels(c) || [],
        e = 0,
        f;
      (f = d[e]);
      e++
      ...
      (f = f.name),
        -1 == a.getVars().indexOf(f) &&
          b.push(
            Blockly.Python.nameDB_.getName(f, Blockly.VARIABLE_CATEGORY_NAME)
          );
    ...
    c = Blockly.Python.nameDB_.getName(
      a.getFieldValue("NAME"),
      Blockly.PROCEDURE_CATEGORY_NAME
    );
    f = "";
    Blockly.Python.STATEMENT_PREFIX &&
      (f += Blockly.Python.injectId(Blockly.Python.STATEMENT_PREFIX, a));
    Blockly.Python.STATEMENT_SUFFIX &&
      (f += Blockly.Python.injectId(Blockly.Python.STATEMENT_SUFFIX, a));
    ...
    d = a.getVars();
    for (e = 0; e < d.length; e++)
      g[e] = Blockly.Python.nameDB_.getName(
        d[e],
        Blockly.VARIABLE_CATEGORY_NAME
      );
    b = "def " + c + "(" + g.join(", ") + "):\n" + b + f + n + k + m + h;
    ...
    switch (a.itemCount_) {
      ...
      case 2:
        ...
        a =
          ...
          "''";
        a =
          Blockly.Python.text.forceString_(b)[0] +
          " + " +
          Blockly.Python.text.forceString_(a)[0];
  ...
  Blockly.Python.text_append = function (a) {
    ...
    return (
      b + " = str(" + b + ") + " + Blockly.Python.text.forceString_(a)[0] + "\n"
    );
  };
